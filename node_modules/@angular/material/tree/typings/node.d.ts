...
export declare class MatTreeNode<T> extends _MatTreeNodeMixinBase<T> implements CanDisable, HasTabIndex {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<MatTreeNode<any>, "mat-tree-node", ["matTreeNode"], { "disabled": "disabled"; "tabIndex": "tabIndex"; "role": "role"; }, {}, never, never, false, never>;
}
/**
...
export declare class MatTreeNodeDef<T> extends _CdkTreeNodeDef<T> {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<MatTreeNodeDef<any>, "[matTreeNodeDef]", never, { "when": "matTreeNodeDefWhen"; "data": "matTreeNode"; }, {}, never, never, false, never>;
}
/**
...
export declare class MatNestedTreeNode<T> extends _MatNestedTreeNodeMixinBase<T> implements AfterContentInit, CanDisable, HasTabIndex, OnDestroy {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<MatNestedTreeNode<any>, "mat-nested-tree-node", ["matNestedTreeNode"], { "disabled": "disabled"; "tabIndex": "tabIndex"; "node": "matNestedTreeNode"; }, {}, ["nodeOutlet"], never, false, never>;
}
